...
class RSTEmbedder:
    ...
    def get_node_string_pair(self, rst_results, output_file="node_embeddings.npz"):
        ...
        for index, rst_result in enumerate(rst_results):
            ...
            pre_leaf_node_string_list = rst_result["news1_edu_strings"]
            ...
            hyp_leaf_node_string_list = rst_result["news2_edu_strings"]
    ...
    def get_hypothesis_emb(self, train_data, emb_output_path):
        ...
        for item in train_data:
            hypothesis_list.append(item["hypothesis"])
...
if __name__ == "__main__":
    ...
    overall_save_dir = r"/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli"
    graph_infos_dir = r"/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/graph_infos"
    ################################################################################

    train_data_path = (
        "/mnt/nlp/yuanmengying/ymy/data/nli_type_data/v2/train_re_hyp.json"
    )
    train_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/train/rst_result.jsonl"
    )
    train_re_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/train/train1/new_rst_result.jsonl"
    )
    train_pre_emb_path = (
    ...
    ################################################################################
    dev_data_path = "/mnt/nlp/yuanmengying/ymy/data/nli_type_data/v2/dev_re_hyp.json"
    dev_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/dev/rst_result.jsonl"
    )
    dev_re_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/dev/dev1/new_rst_result.jsonl"
    )
    dev_pre_emb_path = (
    ...
    dev_lexical_path = "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/graph_infos/dev/lexical_matrixes.npz"
    ################################################################################
    test_data_path = "/mnt/nlp/yuanmengying/ymy/data/nli_type_data/v2/test_re_hyp.json"
    test_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/test/rst_result.jsonl"
    )
    test_re_rst_result_path = (
        "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/test/test1/new_rst_result.jsonl"
    )
    test_pre_emb_path = (
    ...
    test_lexical_path = "/mnt/nlp/yuanmengying/ymy/data/new_2cd_nli/graph_infos/test/lexical_matrixes.npz"
    ################################################################################
